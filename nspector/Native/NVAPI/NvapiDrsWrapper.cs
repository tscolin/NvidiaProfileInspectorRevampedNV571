...
namespace nspector.Native.NVAPI2
{
    ...
    {
        public bool isMetro { readonly get => (bitvector1 & 1) != 0; set => bitvector1 |= value ? 1u : 0u; }
        public bool isCommandLine { readonly get => (bitvector1 & 2) != 0; set => bitvector1 |= value ? 2u : 0u; }
    ...
    {
        public bool isMetro { get => (bitvector1 & 1) != 0; set => bitvector1 |= value ? 1u : 0u; }
        public bool isCommandLine { get => (bitvector1 & 2) != 0; set => bitvector1 |= value ? 2u : 0u; }
